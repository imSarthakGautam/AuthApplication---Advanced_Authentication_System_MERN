...
function EmailVerificationPage(props) {
    ...
    const handleSubmit = async (ev)=>{
        ...
        try{
            ...
            console.log('Error in submiting verification code:',error)
    ...
    //Auto-submit when all input feilds are filled
    useEffect(() => {
    ...
    return (
       <div className='max-w-md w-full bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden  mt-44 mb-auto'>
        ...
        >
            ...
            <p className='text-center text-xl text-gray-300 mb-6'>Enter the 6-digit code sent to your email address.</p>
